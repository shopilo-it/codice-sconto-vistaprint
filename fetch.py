#!/usr/bin/env python3
"""
Recupero codici sconto Vistaprint da shopilo.it
Sursa: https://shopilo.it/negozi/vistaprint.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/vistaprint.it"
STORE_NAME = "Vistaprint"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Vistaprint da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-vistaprint)"
    }
    try:
